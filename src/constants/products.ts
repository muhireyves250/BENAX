...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    price: 15000,
    description: 'The standard microcontroller board for beginner and advanced prototyping. Features the ATmega328P processor, 14 digital input/output pins, and 6 analog inputs.',
    rating: 4.8,
  ...
  },
  {
    ...
    category: 'microcontrollers',
    price: 70000,
    description: 'The classic single-board computer from Raspberry Pi. Features a 1.2GHz 64-bit quad-core ARMv8 CPU, onboard 802.11n Wi-Fi, Bluetooth 4.1, and 1GB RAM.',
    rating: 4.7,
  ...
  },
  {
    ...
    category: 'sensors',
    price: 5000,
    description: 'A classic distance measuring sensor module using ultrasonic pulses. Ideal for collision avoidance, navigation in robotics, and fluid level measurements.',
    rating: 4.5,
  ...
  },
  {
    ...
    category: 'iot',
    price: 10000,
    description: 'A miniature WiFi development board based on ESP-8266EX. Compatible with Arduino, NodeMCU, and MicroPython, perfect for budget IoT projects and smart home automation.',
    rating: 4.9,
  ...
  },
  {
    ...
    category: 'microcontrollers',
    price: 95000,
    description: 'The powerful latest generation single-board computer from Raspberry Pi. Features 4GB LPDDR4 RAM, dual HDMI 4K display support, gigabit ethernet, USB 3.0, and USB-C power input.',
    rating: 4.9,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDOQXVukoX0ai2ferdZoBd1kDDwMru0SOVxMLjn6_AANeTubPZytDSXFBVX6vDozjebyoW7gN9JinKd2vGTHpNqn23yGy5zasZd7rzex_gQfkMGzvm88gThw0oSe6RxJdt2O9k-bIw8wL_vEgH9xASp8S9rzzaEc7b71Dd2k2fgeVrOIevTGt2Qe8JKmhT_zbT_sTmqiU2Jlg-7XrlazTep0M4VZttsWZ3wJoE_1f_yViKJfLA991a6ehF3ZS-N6O9SZLyTzzmChPQ',
    stock: 8,
  ...
  },
  {
    ...
    category: 'iot',
    price: 12000,
    description: 'An advanced dual-core microchip with integrated Wi-Fi and Bluetooth. Ideal for high-end IoT applications, security protocols, sensor hubs, and camera feeds.',
    rating: 4.8,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuD5aFjg18LUSPjC2ZO4cfqPmDfEz_ii8yf59x_IjESmRnSB_rVuQX_pWgYhbb-rOjb5awvkPwQoKlWPqT3wo8fAeA9Y5eqEXTabbPP0Z4D5k6nNa-kjeVHfTBPnX45GIHtflYf868AOZK5xzWThP3a7Y5vDb-lMJ1S9GY6ifdHEYy6lW9EKBvFK-W_6JG5BDeQWO0JIUQRzaqkkGLDBhn-WsKRhGWkIoAliOI4Cy18W_oQKnj1U_9p9cCac5W4xdlOW0ycyer5hBbw',
    stock: 50,
    tag: 'Dual Core',
  ...
  },
  {
    ...
    category: 'motors',
    price: 4000,
    description: 'A light, high-quality micro servo motor capable of rotating 180 degrees. Widely used in RC airplanes, robotic arms, obstacle-avoiding cars, and lock mechanisms.',
    rating: 4.4,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCHfL4D_eNBkflb4LYMWKOkjAaTb_ztyOKpIRSYq_cjy3vB1Wzsa4wXUcPfh4FuZutGQlFRO6cy6MbidaVFryC040Gcnc3fpO66o6AFjGZg6LncUYfoqtYw3xN5FmzziVwu-CDSRHw0qx8tJI8OUzJyWauSkzza0okp58VibsQsKBY-AIUkKDAIiDGPF0D2acMOkqBDhvasrMHU9FLysgisjwFz66lVsz3ee1cWA9pHbvHBDci5aOMnGBykY5ZkwLmLoU7YDcXi1dc',
    stock: 150,
    tag: 'Bargain',
  ...
  },
  {
    ...
    category: 'kits',
    price: 35000,
    description: 'A complete mechanical chassis system with 4 DC gear motors, rubber wheels, speed encoders, battery boxes, and structural accessories. Add a controller board and sensor to build autonomous vehicles.',
    rating: 4.6,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDtLbjdsNAZdxUlYrOVoU9NXptSTpIZBGvWqK8SNkq0YO7CzkK4yCO_KKUunK3DLlV1EJZeNofudlJM7-ugtGBWfUjOKP64ZEXznlqTQkhSarcSiP3F5EtW-XSWP7aFkKbApiEeor4U6_YyWfI-36ZNVI_NNFC-8ijkZIFY2ggy6ijDtPhUI50FKGFxVe4Q6U9B60nldLJh1YlmwDkaCAaKhSa8EI3aBsekPZ7Fne-3nxXQH-qveYRq0EfmhC1jqaRhZSjTdUvTzoI',
    stock: 18,
    tag: 'Robotics',
  ...
  },
  {
    ...
    category: 'sensors',
    price: 3000,
    description: 'A basic, low-cost digital temperature and humidity sensor. Uses a capacitive humidity sensor and a thermistor to measure the surrounding air, providing digital data output.',
    rating: 4.3,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCHfL4D_eNBkflb4LYMWKOkjAaTb_ztyOKpIRSYq_cjy3vB1Wzsa4wXUcPfh4FuZutGQlFRO6cy6MbidaVFryC040Gcnc3fpO66o6AFjGZg6LncUYfoqtYw3xN5FmzziVwu-CDSRHw0qx8tJI8OUzJyWauSkzza0okp58VibsQsKBY-AIUkKDAIiDGPF0D2acMOkqBDhvasrMHU9FLysgisjwFz66lVsz3ee1cWA9pHbvHBDci5aOMnGBykY5ZkwLmLoU7YDcXi1dc',
    stock: 200,
    specs: {
  ...
  },
  {
    ...
    price: 3500,
    description: 'High-quality multicolored ribbon of 40 individual male-to-female jumper wires. Easily separable, standard 2.54mm pitch connectors ideal for breadboards and microcontrollers.',
    rating: 4.8,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDtLbjdsNAZdxUlYrOVoU9NXptSTpIZBGvWqK8SNkq0YO7CzkK4yCO_KKUunK3DLlV1EJZeNofudlJM7-ugtGBWfUjOKP64ZEXznlqTQkhSarcSiP3F5EtW-XSWP7aFkKbApiEeor4U6_YyWfI-36ZNVI_NNFC-8ijkZIFY2ggy6ijDtPhUI50FKGFxVe4Q6U9B60nldLJh1YlmwDkaCAaKhSa8EI3aBsekPZ7Fne-3nxXQH-qveYRq0EfmhC1jqaRhZSjTdUvTzoI',
    stock: 300,
    specs: {
