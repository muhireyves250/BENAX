    ...
    return (
      <div className="w-full flex flex-col gap-1 text-left">
        {label && (
          <label
            htmlFor={inputId}
            className="text-label-sm font-semibold uppercase tracking-wider text-secondary dark:text-slate-400"
          >
            {label}
          </label>
        )}
        <div className="relative rounded-xl">
          ...
          <input
            ...
            ref={ref}
            className={`
              block w-full rounded-xl border text-body-md transition-all duration-200
              ${leftIcon ? 'pl-10' : 'pl-3.5'} pr-3.5 py-2.5
